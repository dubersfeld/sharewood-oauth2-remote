...
/**
 * This filter captures the redirect URI before the Authorization Code Grant login
 * and stores it as a session attribute
 * */
...
public class RedirectFilter implements Filter {
            ...
            throws IOException, ServletException
    {
        ...
        String patternString1 = contextPath + "/login.*";
        String patternString2 = contextPath + "/css.*";
